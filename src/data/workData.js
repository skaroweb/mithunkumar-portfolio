import Lakmeacademy from "../assets/images/portfolio/lakme-academy.png";
import Oceangreen from "../assets/images/portfolio/oceangreen.png";
import Brandanimators from "../assets/images/portfolio/brandanimators.png";
import Softmarksolutions from "../assets/images/portfolio/softmarksolutions.png";
import Careboxhealthcare from "../assets/images/portfolio/careboxhealthcare.png";
import Innerfocusbytam from "../assets/images/portfolio/innerfocusbytam.png";
import Trypuremoringa from "../assets/images/portfolio/trypuremoringa.png";
import Kuvingsisrael from "../assets/images/portfolio/kuvings-israel.png";
import Funkeschlusseldienst from "../assets/images/portfolio/funke-schlusseldienst.png";
import Probit from "../assets/images/portfolio/pro-bit.png";
import Villagetalkies from "../assets/images/portfolio/villagetalkies.png";
import Rajumagi from "../assets/images/portfolio/rajumagi.png";
import Natarajnilastore from "../assets/images/portfolio/natarajnilastore.png";
import Zzztape from "../assets/images/portfolio/zzztape.png";
import Travoka from "../assets/images/portfolio/travoka.png";
...
let WorkData = [
  {
    id: 1,
    projectName: "Lakme academy",
    projectDetails:
      "Lakmē Academy powered by Aptech is a leading beauty training institute in India offering professional courses in cosmetology, makeup, hair, and skincare to help you build a successful career in the beauty industry.",
...

  {
    ...
    projectDetails:
      "Best 2D/3D animated explainer video production company in Houston, Dallas, TX &amp; San Francisco, California, USA offers explainer videos, corporate videos, 3d product animation videos, 3d medical animation videos, 3d architectural walkthrough animation, product demo videos, app explainer videos, e-Learning videos, Motion Graphics, whiteboard videos, character animation videos, employee training videos, marketing videos and more.",
    projectTechnologies: ["HTML", "CSS", "JavaScript", "Elementor"],
    imageURL: Brandanimators,
  },
  {
    id: 4,
    projectName: "Softmark solutions",
    projectDetails:
      "With SEO, Google Ads, tracking and Google My Business, we bring your company to the forefront online – for measurable success and more customers",
    projectTechnologies: ["HTML", "CSS", "JavaScript", "Elementor"],
    imageURL: Softmarksolutions,
  },
  ...
  {
    id: 7,
    projectName: "Trypuremoringa",
    projectDetails:
      "Pure Moringa supports mental clarity, boosts energy, and holistically heals your body - making tough mornings a thing of the past.",
  ...
  {
    id: 9,
    projectName: "Funke schlusseldienst",
    projectDetails:
      "Reliable locksmith service in Berlin – fast & trustworthy! Fast, reliable locksmith service in Berlin – available 24 hours a day! Fair prices, professional assistance, and maximum security.",
    projectTechnologies: ["HTML", "CSS", "Fusion Builder"],
  ...
  {
    id: 11,
    projectName: "Villagetalkies",
    projectDetails:
      "Village Talkies is the top corporate video production company and best animated explainer video production company in Dubai, UAE. Renowned as one of the best 2D/3D animation studio in Dubai, UAE specialized in creating high-quality 3d animation videos, 2d animation videos, corporate videos, brand films, training videos, safety videos, animated explainer videos  etc. delivering budget-friendly solutions without compromising on quality. Village Talkies is your go-to partner for all your video production needs in Dubai, UAE.",
    projectTechnologies: ["HTML", "CSS", "JavaScript", "Elementor"],
    imageURL: Villagetalkies,
  },

  {
    id: 12,
    projectName: "Rajumagi",
    projectDetails:
      "At Rajumagi, we’re diving into a sea of creativity and fun! Founded by a quirky crew who loves all things whimsical and vibrant, we set out to create a brand that reflects our personalities—colorful, playful, and a bit unpredictable!",
    projectTechnologies: ["HTML", "CSS", "jQuery", "Woocommerce"],
    imageURL: Rajumagi,
  },

  {
    id: 13,
    projectName: "Nataraj nila store",
    projectDetails:
      "At natarajnilastore.in, we’re diving into a sea of creativity and fun! Founded by a quirky crew who loves all things whimsical and vibrant, we set out to create a brand that reflects our personalities—colorful, playful, and a bit unpredictable!",
    projectTechnologies: ["HTML", "CSS", "Wordpress", "Woocommerce"],
    imageURL: Natarajnilastore,
  },

  {
    ...
    projectName: "ZZZtape",
    projectDetails:
      "Experience the Life-Changing Benefits of Nose Breathing with the Ideal Mouth Tape & Nasal Strips.",
    projectTechnologies: ["HTML", "CSS", "jQuery", "Shopify"],
    imageURL: Zzztape,
  },
  ...
  {
    id: 16,
    projectName: "Vitaboosterpro",
    projectDetails:
      "Eating Healthy Is Crucial For Overall Well-Being As It Provides Essential Nutrients That Support Bodily Functions, Boost The Immune System, And Maintain A Healthy Weight. A Balanced Diet Rich In Fruits, Vegetables, Whole Grains, And Lean Proteins Can Improve Overall Wellbeing.",
    projectTechnologies: ["HTML", "CSS", "JavaScript", "Shopify"],
    imageURL: Vitaboosterpro,
  },

  {
    id: 17,
    projectName: "Shopbiogrowrx",
    projectDetails:
      "Unlock Luscious Locks And Promote Hair Growth With Our Advanced Hair Growth Supplement. Experience The Ultimate In Hair Health And Vitality.",
    projectTechnologies: ["HTML", "CSS", "JavaScript", "Shopify"],
    imageURL: Shopbiogrowrx,
  },

  {
    ...
    projectName: "Psgrand",
    projectDetails:
      "No matter what type of work you do, PS Grand has the most jobs, the best tools, and expert advice to help you get cast.",
    projectTechnologies: ["HTML", "CSS", "JavaScript", "Shopify"],
    imageURL: Psgrand,
  },
  {
